deps_config := \
	/root/.unikraft/apps/micropython/Config.uk \
	/root/.unikraft/libs/lib-tinyalloc/Config.uk \
	/root/.unikraft/libs/lib-compiler-rt/Config.uk \
	/root/.unikraft/libs/lib-micropython/Config.uk \
	/root/.unikraft/libs/newlib/Config.uk \
	/root/.unikraft/libs/lwip/Config.uk \
	/root/.unikraft/libs/pthread-embedded/Config.uk \
	...
	/root/.unikraft/unikraft/lib//sassy-fork/Config.uk \
	...
	/root/.unikraft/unikraft/lib//posix-environ/Config.uk \
	...
	/root/.unikraft/apps/micropython/build/kconfig/libs.uk \
	...
	/root/.unikraft/apps/micropython/build/kconfig/plat.uk \
...
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: \
	$(deps_config)

ifneq "$(UK_FULLVERSION)" "0.5.0~1570316b9-custom"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(UK_APP)" "/root/.unikraft/apps/micropython"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
ifneq "$(UK_NAME)" "micropython"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
ifneq "$(CC)" "/root/llvm1/llvm-project-releases/bin/clang"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(KCONFIG_PLAT_IN)" "/root/.unikraft/apps/micropython/build/kconfig/plat.uk"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
ifneq "$(KCONFIG_LIB_DIR)" "/root/.unikraft/unikraft/lib//9pfs /root/.unikraft/unikraft/lib//cpio /root/.unikraft/unikraft/lib//devfs /root/.unikraft/unikraft/lib//fdt /root/.unikraft/unikraft/lib//flexos-core /root/.unikraft/unikraft/lib//kasan /root/.unikraft/unikraft/lib//nolibc /root/.unikraft/unikraft/lib//posix-environ /root/.unikraft/unikraft/lib//posix-event /root/.unikraft/unikraft/lib//posix-libdl /root/.unikraft/unikraft/lib//posix-mmap /root/.unikraft/unikraft/lib//posix-process /root/.unikraft/unikraft/lib//posix-sysinfo /root/.unikraft/unikraft/lib//posix-user /root/.unikraft/unikraft/lib//ramfs /root/.unikraft/unikraft/lib//sassy-fork /root/.unikraft/unikraft/lib//syscall_shim /root/.unikraft/unikraft/lib//ubsan /root/.unikraft/unikraft/lib//uk9p /root/.unikraft/unikraft/lib//ukalloc /root/.unikraft/unikraft/lib//ukallocbbuddy /root/.unikraft/unikraft/lib//ukallocpool /root/.unikraft/unikraft/lib//ukallocregion /root/.unikraft/unikraft/lib//ukargparse /root/.unikraft/unikraft/lib//ukblkdev /root/.unikraft/unikraft/lib//ukboot /root/.unikraft/unikraft/lib//ukbus /root/.unikraft/unikraft/lib//ukdebug /root/.unikraft/unikraft/lib//uklibparam /root/.unikraft/unikraft/lib//uklock /root/.unikraft/unikraft/lib//ukmmap /root/.unikraft/unikraft/lib//ukmpi /root/.unikraft/unikraft/lib//uknetdev /root/.unikraft/unikraft/lib//ukring /root/.unikraft/unikraft/lib//uksched /root/.unikraft/unikraft/lib//ukschedcoop /root/.unikraft/unikraft/lib//uksglist /root/.unikraft/unikraft/lib//uksignal /root/.unikraft/unikraft/lib//uksp /root/.unikraft/unikraft/lib//ukswrand /root/.unikraft/unikraft/lib//uktime /root/.unikraft/unikraft/lib//uktimeconv /root/.unikraft/unikraft/lib//vfscore /root/.unikraft/unikraft/lib /root/.unikraft/libs/pthread-embedded /root/.unikraft/libs/lwip /root/.unikraft/libs/lib-compiler-rt /root/.unikraft/libs/newlib /root/.unikraft/libs/lib-micropython /root/.unikraft/libs/lib-tinyalloc"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
ifneq "$(KCONFIG_LIB_IN)" "/root/.unikraft/apps/micropython/build/kconfig/libs.uk"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
ifneq "$(KCONFIG_APP_DIR)" "/root/.unikraft/apps/micropython"
/root/.unikraft/apps/micropython/build/kconfig/auto.conf: FORCE
endif
