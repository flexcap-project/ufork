...
typedef uk_syscall_arg_t syscall_arg_t;
 intptr_t __syscall_ret(uintptr_t), __syscall(uk_syscall_arg_t, ...),
...
static inline intptr_t __alt_socketcall(int sys, int sock, int cp, syscall_arg_t a, syscall_arg_t b, syscall_arg_t c, syscall_arg_t d, syscall_arg_t e, syscall_arg_t f)
{
	intptr_t r;
